...
public class Login_resurse_umane extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Login_resurse_umane frame = new Login_resurse_umane();
	...
	public Login_resurse_umane() {
		...
		JLabel lblNewLabel = new JLabel("Autentificare administrator resurse umane");
