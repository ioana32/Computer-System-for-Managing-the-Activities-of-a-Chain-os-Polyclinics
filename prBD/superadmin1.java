...
public class superadmin1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					superadmin1 frame = new superadmin1();
	...
	public superadmin1() {
		...
		btnUpdateTabel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					pst.execute(sql1);
					JOptionPane.showMessageDialog(null," Modificare date cu succes! ");
		...
		btnDelogare.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				principala psad1=new principala();
				psad1.show();
				dispose();
			}
		});
		...
		btnDelogare.setBounds(1059, 714, 117, 29);
